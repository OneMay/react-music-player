...
export default class Player extends React.Component {
  constructor(props) {
    ...
    this.changeVolumenHanler = this.changeVolumenHanler.bind(this);
  ...
  componentWillUnmount() {
    $("#jplay").unbind($.jPlayer.event.timeupdate);
  }
  changeProgress(progress) {
    $("#player").jPlayer("play", duration * progress);
  }
  changeVolumenHanler(progress) {
              ...
              <div className="volume-container">
                ...
                <div className="volume-wrapper">
                  <Progress
                    ...
                    onProgressChange={this.changeVolumenHanler}
                    bgColor="#aaa"
                  />
                </div>
              </div>
